...
const NewNote = (props) => {
    ...
    useEffect(() => {
        if (props.currentEvent && props.currentEvent._id && form.event !== props.currentEvent._id) {
            setForm(prev => ({
                ...prev,
                event: props.currentEvent._id
            }));
    ...
    const createNote = async () => {
        try {
            ...
            if (!form.event) {
                ...
                throw new Error('No event selected. Please refresh the page and try again.');
            }
    ...
    const validate = () => {
        ...
        if (form.description && truncateDescription(form.description).length > 200) {
    ...
    const truncateDescription = (text) => {
        ...
        if (lastSpace > maxLength * 0.7) { // Only if we're not too far back
    ...
    const truncateTitle = (text) => {
        ...
        if (lastSpace !== -1 && lastSpace > 5) { // Only if we're not too far back
            ...
            <div className="wish-container">
                ...
                <div className="wish-content">
                    <div className="wish-header">
                        ...
                        <p className="wish-subtitle">Create a new wish for your gift registry</p>
                    </div>
                    ...
                    {!form.event && (
                        <div className="event-warning">
                            ...
                            <div className="warning-text">
                                <strong>No event selected</strong> - Please refresh the page or return to the dashboard to select an event.
                            </div>
                        </div>
                    )}
                            ...
                            <form onSubmit={handleSubmit} className="wish-form">
                                <div className="form-group">
                                    ...
                                    <p className="url-hint">
                                        Works with any e-commerce site worldwide! Paste a product URL from Amazon, Target, Walmart, or any online store.
                                    </p>
                                </div>
                                ...
                                <div className="form-group">
                                    ...
                                    <input
                                        ...
                                        value={form.title}
                                    />
                                    <div className={`char-counter ${truncateTitle(form.title).length > 40 ? 'char-counter-warning' : ''}`}>
                                        {truncateTitle(form.title).length}/40 characters
                                        {form.title.length > 40 && truncateTitle(form.title).length <= 40 && (
                                            <span className="truncation-notice"> (will be truncated)</span>
                                        )}
                                    </div>
                                ...
                                <div className="form-group">
                                    ...
                                    <textarea
                                        ...
                                        rows="4"
                                    />
                                    <div className={`char-counter ${truncateDescription(form.description).length > 200 ? 'char-counter-warning' : ''}`}>
                                        {truncateDescription(form.description).length}/200 characters
                                        {form.description.length > 200 && truncateDescription(form.description).length <= 200 && (
                                            <span className="truncation-notice"> (will be truncated)</span>
                                        )}
                                    </div>
                                    ...
                                    >
                                        {uploading ? (
                                            ...
                                            <div className="upload-placeholder">
                                                ...
                                                <p className="upload-text">Drag and drop an image here, or <span className="upload-link">browse</span></p>
