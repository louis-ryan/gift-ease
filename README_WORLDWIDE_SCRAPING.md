...
'[data-test*="title"]', '[data-testid*="title"]', '[data-automation*="title"]'
...
'[data-test*="price"]', '[data-testid*="price"]', '[data-automation*="price"]'
...
'[class*="description"]', '[class*="details"]', '[class*="summary"]', '[class*="overview"]'
'[data-test*="description"]', '[data-testid*="description"]', '[data-automation*="description"]'
...
'[class*="product-image"]', '[class*="item-image"]', '[class*="product-photo"]'
'[data-test*="image"]', '[data-testid*="image"]', '[data-automation*="image"]'
